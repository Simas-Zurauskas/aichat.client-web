...
export const Empty: React.FC<EmptyProps> = ({ onClick }) => {
  return (
    <Div>
      ...
      <Box mt={4} />
      <Typography variant="h4">Welcome, please create your node</Typography>
      <Box mt={2} />
      <Typography variant="body1">Click on Create new button to start building your first node.</Typography>
      <Box mt={6} />
